...
public class AlertDialogActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    private void bindView() {
        Button btn_dialog_one = (Button) findViewById(R.id.btn_dialog_one);
        Button btn_dialog_two = (Button) findViewById(R.id.btn_dialog_two);
        Button btn_dialog_three = (Button) findViewById(R.id.btn_dialog_three);
        Button btn_dialog_four = (Button) findViewById(R.id.btn_dialog_four);
